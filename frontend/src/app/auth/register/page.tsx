  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-background">
      <form
        ...
        className="bg-white p-8 rounded-xl shadow-sm w-full max-w-2xl space-y-8 border"
      >
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input {...formRegister("username")} className="pl-10" />
                  </div>
                  {errors.username && (
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input {...formRegister("street")} className="pl-10" />
                  </div>
                  {errors.street && (
                    <p className="text-red-500 text-sm mt-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <Input {...formRegister("city")} className="pl-10" />
                    </div>
                    {errors.city && (
                      <p className="text-red-500 text-sm mt-1">
                        {errors.city.message}
